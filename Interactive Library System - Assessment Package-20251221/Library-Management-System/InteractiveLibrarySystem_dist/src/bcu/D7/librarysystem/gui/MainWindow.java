    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if (ae.getSource() == adminExit) {
            ...
            try {
                ...
                bcu.D7.librarysystem.commands.Command cmd = new bcu.D7.librarysystem.commands.DeleteBook(bid);
            ...
            } catch (bcu.D7.librarysystem.main.LibraryException ex) {
            ...
            try {
                ...
                if (rc != javax.swing.JOptionPane.YES_OPTION) return;
                bcu.D7.librarysystem.commands.Command cmd = new bcu.D7.librarysystem.commands.DeletePatron(pid);
                cmd.execute(library, java.time.LocalDate.now());
                displayPatrons();
            } catch (NumberFormatException ex) {
